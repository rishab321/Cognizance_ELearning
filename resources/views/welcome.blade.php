...
<section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" >
      <div class="row">
        <div class="col-xl-6">
          <h1 style="color: rgba(212, 54, 14, 0.959)">E-Learning</h1>
          <h2 style="color: rgb(16, 202, 131)">Start, switch, or advance your career with more than 50 courses, Professional Certificates, and degrees from world-class universities and companies.</h2>
          <a href="#about" class="btn-get-started scrollto">Buy your Courses</a>
        </div>
      </div>
    </div>
